...
| Tag | Meaning |
|---|---|
| **[SHEET]** | Printed on one of the official sheets, or derived directly from the general ruleset (Book IV). Authoritative. |
| **[INF]** | Extrapolated to fill an obvious gap. |
| **[GM]** | Table ruling — invented at this table, not on any general sheet. |
| **[CONFLICT]** | Sheets and the Jutsu Compendium disagree. Flagged, not resolved. |
...
| **Sensei of record (former)** | **Genzo Ishikawa** — jōnin, **KIA**, roughly a year into the war. Souji's first sensei. See Part Nine. |
| **Day-to-day sensei** | Rokka Uehara ("Roku"), jōnin — same as Ardo and Suzume, as of this session |
| **Cell** | Konoha Cell 409 |

## Why He's Been Between Cells Twice

**First cell:** Genzo Ishikawa's squad. Genzo died on a border skirmish eight months into the war — the kind of loss that doesn't make it into any history, just a line on a report and a squad that gets dissolved because there's no sensei left to run it. Souji was reassigned to a holding roster while a new placement was found.

**Second cell:** Lasted eleven days. The squad he'd been slotted into needed to absorb a clan heir mid-cycle for political reasons nobody explained to a genin — the Hyūga wanted their kid training with a specific jōnin, and the easiest name to move off the roster to make room was the clanless one. Nobody told him it was personal. It wasn't. That's almost worse.

**What this means for how he plays:** Souji doesn't perform hurt about it. He's had a year to make peace with the fact that "clanless" means "the one who gets moved" more often than it should, and the response he's landed on isn't bitterness — it's making sure nobody ever has an operational reason to move him again. Be quietly, relentlessly *useful*, and the paperwork stops mattering.
...
*Chakra Max = 100 + 10×CON mod, then Body Origin. Stamina Max = 100 + 10×CON mod, then Body Origin.*
...
**POWERFUL LIFE FORCE** **[SHEET — Body of Ashura]**
Recover **5 Stamina at the start of each combat round.**

**CLANLESS** **[SHEET]**
+1 to STR (already applied above). One extra starting **feat** and one extra starting **jutsu** (both baked into his kit below — see the note on 完結 Kanketsu). Cannot naturally learn Kekkei Genkai or clan-exclusive jutsu. **This is the build Naruto, Rock Lee, and Might Gai run**, and the sheet is explicit that it's not a consolation prize.

**READS THE ROOM BEFORE HE SPEAKS** **[GM]**
When Souji has a moment to actually watch someone before engaging with them — combat or otherwise — he gets **advantage on the first Perception or Insight-equivalent check** made about them that scene. He's spent a year being the new guy dropped into rooms he didn't choose; he's good at fast, accurate reads because he's had to be.
...
**Rank:** Unranked **[SHEET, general kit]**
**Type:** Kenjutsu
**Status:** Learned
**Cost:** None
**Action:** 1 Action
...
Souji's default answer to most problems. Clean cuts, no wasted motion, minimal flourish — the opposite of Ardo's improvised chaos and a different register entirely from Suzume's precision-through-prediction. His precision is just *practice*.

---

## D-EARTH-01 — EARTH RELEASE: ROOT GRIP

**Japanese:** 土遁・根縛り (Doton: Ne Shibari)
**Type:** Earth Release Ninjutsu
**Rank:** D **[GM — original, fits the affinity]**
**Status:** Learned
**Cost:** 9 Chakra / 4 Stamina
**Action:** 1 Action · 1 slot
**Range:** 20 ft
**Target:** One creature or a 5-ft square of ground

### Effect

The ground beneath the target erupts into gripping root-like stone tendrils. **DEX save vs. Souji's Ninjutsu DC (10)** or the target's Speed drops to 0 until they spend an action breaking free (STR check, same DC). On a successful save, the target's Speed is merely halved until the end of their next turn.

### Tactical Use

Not a damage technique. It's the reason a taijutsu specialist without ninjutsu depth can still control space — pin something in place, then close with the blade. Pairs naturally with anyone who needs a target to *stay* somewhere for a beat, which on this squad is going to come up constantly.

---

## D-KEN-01 — KENJUTSU: FALLING LEAF CUT

**Japanese:** 剣術・落葉斬り (Kenjutsu: Rakuyō Giri)
**Type:** Kenjutsu
**Rank:** D **[GM — original]**
**Status:** Learned
...
A deliberately unbalancing cut, angled to disrupt footing rather than just wound. This is Souji's opener of choice in a team fight — not the biggest hit available to him, but the one that sets someone else's biggest hit up to land clean.
...
**Rank:** D, functionally — **unranked by convention, like a dōjutsu, since it isn't a chakra technique at all** **[GM — Clanless bonus jutsu, taught by Genzo before he died]**
**Status:** Learned
...
*"Most fights are decided by the person who's still moving when everyone else has already committed. Stop. Watch. Cut once."* Kanketsu isn't a combo piece — it's the opposite of one. Souji goes deliberately quiet mid-fight, sheathes rather than draws, and waits for exactly one opening. If it comes, one cut ends whatever it touches. If it doesn't come before the setup lapses (end of Souji's next turn), the Stamina's spent for nothing and he's lost a full round doing nothing but watching.

### Limitation

**Once per combat encounter.** This isn't a cooldown so much as a genuine limit on how many times a fight can hold that kind of stillness before it stops being a weapon and starts being a liability. Souji knows this. He doesn't overuse it.

### Why It's His

This is the extra jutsu the Clanless bonus grants, and it's not replaceable, tradeable, or something another clan's kekkei genkai could ever produce — it's discipline, transmitted person to person, from a sensei who's gone. **Every time he uses it, it's Genzo's hands as much as his own.**
...
- **Kenjutsu path:** Falling Leaf Cut and baseline swordwork are the floor, not the ceiling. A C-rank kenjutsu evolution is the obvious next unlock once he's logged real mastery reps — probably something that lets Kanketsu's stillness extend past a single strike.
...
# PART SEVEN — EQUIPMENT & FINANCES

| Item | Count | Notes |
|---|---|---|
| Short blade (unnamed) | 1 | Standard steel, not chakra-conductive, not enchanted. Just well-maintained. |
| Kunai | 10 | |
| Shuriken | 12 | |
| Whetstone | 1 | Used more than most genin bother to |
| Field dressing | — | |
| **Ryō** | 6,000 | Genin-standard, no windfalls yet |

---
---

# PART EIGHT — STORY, SECRETS & OPEN THREADS

## The Three Questions **[per the campaign's own session-zero convention]**

**1 — Who taught you?** Genzo Ishikawa, for eight months, until the border skirmish that killed him. Roku is the second sensei he's had who's actually stayed.

**2 — What did the war take from you?** A sensei, and then — less dramatically, more quietly corrosive — a sense that being good at this was ever going to be enough to keep him somewhere. He's still recalibrating that second one, and meeting Ardo and Suzume the same week they buried a teammate is not obviously going to make that easier.

**3 — What would make you break the code?** Watching a cell fracture the way his second one didn't even bother to explain itself before doing. If Souji ever sees a version of that happening to Cell 409, he will not wait for permission to stop it.

## Open Threads

1. **What happened to the rest of Genzo's original squad?** Souji was the only one reassigned to a holding roster — the sheet doesn't yet say what became of the others. Worth finding out.
2. **The Hyūga heir who displaced him from his second cell.** Never met them. Doesn't resent them personally. Might, someday, meet them anyway — Konoha isn't that big.
3. **The unspent Clanless feat.** Open question, not a mystery — but it's a real decision point about who Souji is becoming, not just what he can do.
4. **Kanketsu's actual origin.** Souji knows Genzo taught it to him. He does not know where *Genzo* learned it, or whether it has a name anywhere outside the two of them who ever used it.
5. **First impression of Cell 409.** He's read the mission report and the shape of what happened to Rai. He hasn't yet said out loud what he thinks about stepping into a cell defined by a loss this fresh — that's a conversation still owed, not avoided on purpose.

---
---

# PART NINE — CELL 409, AS SOUJI SEES IT (SESSION SIX)

**Ardo:** Chūnin vest still creased, headband that isn't his own, talks like every sentence is a down payment on something enormous he's promised the world. Souji's read on him so far, unspoken: *this one runs hot enough to burn out or burn bright, and it's too early to know which.*

**Suzume:** Quieter, watching everything, Sharingan or not. Souji clocked the dōjutsu inside the first minute — hard not to, once you know what you're looking at — and hasn't said anything about it, because it plainly isn't his to bring up first.
